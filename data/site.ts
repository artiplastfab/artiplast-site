...
export const PHONE_LINK = "tel:05469610107";
...
const localeCopy: Record<Locale, LocaleCopy> = {
  tr: {
    ...
    navigation: { home: "Ana Sayfa", products: "Ürünler", about: "Hakkımızda", faq: "SSS", contact: "İletişim" },
    actions: {
      contact: "İletişim",
  ...
  de: {
    ...(() => {
      const en = {
        ...
        navigation: { home: "Startseite", products: "Produkte", about: "Über uns", faq: "FAQ", contact: "Kontakt" },
        actions: {
          contact: "Kontakt",
